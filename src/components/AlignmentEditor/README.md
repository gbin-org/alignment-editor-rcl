...
<AlignmentEditor
  defaultView="tree"
  sourceGlosses={[
    { position: 0, glossText: 'verb' },
    { position: 1, glossText: 'det' },
    { position: 2, glossText: 'noun' },
    { position: 3, glossText: 'noun' },
    { position: 4, glossText: 'det' },
    { position: 5, glossText: 'noun' },
    { position: 6, glossText: 'conj' },
    { position: 7, glossText: 'noun' },
    { position: 7, glossText: 'det' },
    { position: 8, glossText: 'det' },
    { position: 9, glossText: 'noun' },
    { position: 10, glossText: 'conj' },
    { position: 11, glossText: 'noun' },
    { position: 12, glossText: 'verb' },
    { position: 13, glossText: 'noun' },
    { position: 14, glossText: 'conj' },
    { position: 15, glossText: 'verb' },
    { position: 16, glossText: 'verb' },
    { position: 17, glossText: 'pron' },
  ]}
  sourceStrongs={[
    { position: 0, strong: '1230', lang: 'g' },
    { position: 1, strong: '3588', lang: 'g' },
    { position: 2, strong: '4521', lang: 'g' },
    { position: 3, strong: '3137', lang: 'g' },
    { position: 4, strong: '3588', lang: 'g' },
    { position: 5, strong: '3094', lang: 'g' },
    { position: 6, strong: '2532', lang: 'g' },
    { position: 7, strong: '3137', lang: 'g' },
    { position: 7, strong: '3588', lang: 'g' },
    { position: 8, strong: '3588', lang: 'g' },
    { position: 9, strong: '2385', lang: 'g' },
    { position: 10, strong: '2532', lang: 'g' },
    { position: 11, strong: '4539', lang: 'g' },
    { position: 12, strong: '59', lang: 'g' },
    { position: 13, strong: '759', lang: 'g' },
    { position: 14, strong: '2443', lang: 'g' },
    { position: 15, strong: '2064', lang: 'g' },
    { position: 16, strong: '218', lang: 'g' },
    { position: 17, strong: '846', lang: 'g' },
  ]}
  sourceSegments={[
    { text: 'διαγενομένου' },
    { text: 'τοῦ' },
        ...
        children: [
          {
            ...
            text: 'ἵνα',
            children: [
              { type: 'v.part', start: 16, end: 16, text: 'ἐλθοῦσαι' },
            ],
          },
