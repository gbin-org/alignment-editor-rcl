...
export const fetchAlignmentDataFailureAction = (
  error: string
): types.AlignmentActionTypes => {
  return {
...
export const selectSourceTextSegmentAction = (
  position: number
): types.AlignmentActionTypes => {
  return {
...
export const selectTargetTextSegmentAction = (
  position: number
): types.AlignmentActionTypes => {
  return {
...
export const deSelectSourceTextSegmentAction = (
  position: number
): types.AlignmentActionTypes => {
  return {
...
export const deSelectTargetTextSegmentAction = (
  position: number
): types.AlignmentActionTypes => {
  return {
...
export const updateAlignmentData = (
  doc: any,
  verseCode: string
): types.AlignmentActionTypes => {
...
export const updateAlignmentDataAction = (
  dispatch: any,
  verseCode: string,
  doc: any
): any => {
...
export const fetchAlignmentDataAction = (
  projectId: string,
  verseCode: string
): any => {
