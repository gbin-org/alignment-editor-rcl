...
<LinksContainer
  sourceSegments={[
    ...
    {text: 'εἰς', color: 0, group: 0, type: 'source', position: 1, catIsContent: false },
    {text: 'τὸ', color: 0, group: 0, type: 'source', position: 2, catIsContent: false },
...
<LinksContainer
  sourceSegments={[
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 15 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 19 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 23 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 27 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 31 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 35 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 39 },
    ...
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 43 },
    {text: 'בִּשְׁלוֹשָׁ֣ה', color: 0, group: 0, type: 'source', position: 44 },
  ]}
  targetSegments={[
